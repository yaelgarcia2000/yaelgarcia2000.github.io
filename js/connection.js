(() => {
    ...
    xhr.addEventListener("readystatechange", (e) => {
        ...
        /*  document.getElementById("p-e-a1-i").setAttribute("src", data[0].id_pub_sis);
            ...
            document.getElementById("p12-cb-o-a1-v").setAttribute("src", data[32].id_pub_sis);
            document.getElementById("p13-cb-o-a2-i").setAttribute("src", data[33].id_pub_sis);
            document.getElementById("p14-cb-o-a3-v").setAttribute("src", data[34].id_pub_sis);
            document.getElementById("p15-cb-o-a4-i").setAttribute("src", data[35].id_pub_sis);
            document.getElementById("p16-cb-o-a5-v").setAttribute("src", data[36].id_pub_sis);
            document.getElementById("p17-cb-o-a6-i").setAttribute("src", data[37].id_pub_sis);
            document.getElementById("p18-cb-o-a7-v").setAttribute("src", data[38].id_pub_sis);
            document.getElementById("p19-cb-o-b1-i").setAttribute("src", data[39].id_pub_sis);
            document.getElementById("p20-cb-o-b2-v").setAttribute("src", data[40].id_pub_sis);
            document.getElementById("p21-cb-o-b3-i").setAttribute("src", data[41].id_pub_sis);
            document.getElementById("p22-cb-o-b4-v").setAttribute("src", data[42].id_pub_sis);
            document.getElementById("p23-cb-o-c1-i").setAttribute("src", data[43].id_pub_sis);
            document.getElementById("p24-cb-o-c2-v").setAttribute("src", data[44].id_pub_sis);
            document.getElementById("p25-cb-o-d1-i").setAttribute("src", data[45].id_pub_sis);
            document.getElementById("p26-cb-o-e1-v").setAttribute("src", data[46].id_pub_sis);
